...
const Home = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch('http://performances-service:80/api/performances');
                ...
                if (isAuthenticated) {
                    try {
                        ...
                        const favoritesResponse = await fetch(`http://favorite-service:80/api/favorites/${username}`);
    ...
    const handleFavorite = async (e, show) => {
        ...
        try {
            ...
            if (isAlreadyFavorite) {
                const response = await fetch(`http://favorite-service:80/api/favorites/${username}/${show.performance_id}`, {
                    method: 'DELETE'
                });
                ...
                const response = await fetch(`http://favorite-service:80/api/favorites/${username}`, {
                    method: 'POST',
                    headers: {
